...
public class MainGame : MonoBehaviour
{
    ...
    public enum ActionType { MOVE, ATK1, ATK2, ATK3, SKIP, WAIT };
                        ...
                        else
                        {
                            switch (actionType)
                            {
                                ...
                                case ActionType.ATK3:
                                    ...
                                    break; // Added ATK3 by Youcef MEDILEH, L3C1
        ...
        if (winner == -1)
        {
            ...
            if (pathWalk == null && updateMouseHover && whoControlsThisChar(currentCharControlled) == PlayerType.HUMAN)
            {
                switch (actionType)
                {
                    ...
                    case ActionType.ATK1: case ActionType.ATK2: case ActionType.ATK3: displayLineOfSight(); break;
    ...
    int actionUseAttack(ActionType attack, Hexa hexaDestination)
    {
        ...
        else attackUsed_ = CharsDB.list[(int)currentCharControlled.charClass].skill_2; //ATK3, by Youcef MEDILEH, L3C1
...
public class EndGameDataCharacter
{
    ...
    {
        this.numberOfAction++;
        if(newAction == MainGame.ActionType.ATK1 || newAction == MainGame.ActionType.ATK2 || newAction == MainGame.ActionType.ATK3)
        {
