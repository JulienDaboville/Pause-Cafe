...
public class MainMenu : MonoBehaviour
{
    ...
    bool[] buttonCharCardsPressed = new bool[8] { false, false, false, false, false, false, false, false };
    bool[] buttonTeam1Enable = new bool[8] { true, true, true, true, true, true, true, true };
    bool[] buttonTeam2Enable = new bool[8] { true, true, true, true, true, true, true, true };
    ...
    void Update()
    {
        ...
        else if (CharSelectMenu.activeInHierarchy)
        {
            ...
            {	
                for (int i = 0; i < 8; i++)//Edited by L3C1 Y,H
                {
...

            {
                ...
                // CHARACTER SELECTION Edited by L3C1 Y,H
                for (int i = 0; i < 8; i++)
                {
